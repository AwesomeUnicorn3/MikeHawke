#!!!!DO NOT CHANGE ANYTHING BEFORE SAVING SCRIPT WITH ENEMY NAME!!!!
...
# warning-ignore:return_value_discarded
	...
	movedir = Vector2(0,0)
	TYPE = "ENEMY" #OBJECT TYPE - DO NOT CHANGE
	spritedir = "Down" #STARTING DIRECTION
